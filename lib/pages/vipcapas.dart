...
class Vipcapas extends StatefulWidget {
  final String username, idUser;

  Vipcapas({Key? key, required this.idUser, required this.username})
      : super(key: key);

  @override
  _VipCapasState createState() => _VipCapasState(idUser: idUser);
}

class _VipCapasState extends State<Vipcapas> {
  late final String idUser;
  _VipCapasState({required this.idUser});
  final title = 'Picking_Nfe';
  final String _data = "waiting...";
  final String _labelType = "waiting...";
  final String _source = "waiting...";
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: title,
      home: Picking_NfePage(title: title, idUser: idUser),
    );
  }
}
...
class Picking_NfePage extends StatefulWidget {
  ...
  @override
  _Picking_NfePageState createState() =>
      _Picking_NfePageState(title: title, idUser: idUser);
}
...
class _Picking_NfePageState extends State<Picking_NfePage> {
  ...
  int _qty = 0;
  late int _barcode, intNFes;
  late String _usr, data, idUser;
  late final String title;
  late bool blFetch = false;

  _Picking_NfePageState({required title, required this.idUser});
  String _KeyNfe = "";
      ...
      body: blFetch
          ? new RefreshIndicator(
              child: FutureBuilder<List<Photo>>(
                future: fetchVwEdItems(
                    idUser, _checkbox, _value.toString(), _courier.toString()),
  ...
  Future getAccessKey(_KeyNfe) async {
    var response = await http.get(
        ...
        Uri.parse("http://www.tiven.com.br/picking/InsPickingByNfeKey.php?keynfe=$_KeyNfe&idUser=$idUser"),
...
class _PhotosListState extends State<PhotosList> {
  ...
  String _imagePath = '';
  late bool saved, _notFound, _badLabel, _urgRepo;
